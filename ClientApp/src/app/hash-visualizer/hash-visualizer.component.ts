...
export class HashVisualizerComponent implements OnInit { // https://bl.ocks.org/mbostock/4062045
    ...
    drawGraph() {
        ...
        let graph: { links, nodes } = this.getData(); // this probably needs to go back to D3.json
        ...
        simulation.force('link').links(graph.links); // may need fixing  links x1 x3 x4 are huge negative numbers




        function ticked() { // probably a scope problem here. x and y values do not match.
            link
    ...
    getData() {
        //    return { nodes: [{id: 'Myriel', group: 1},{id: 'Napoleon', group: 1}],
